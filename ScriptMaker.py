...
class ScriptMaker(object):
    ...
    def make_script(self):
        ...
        self.exploit += self.tab*3 + "print" + "\n"
        self.exploit += self.tab*3 + "print \"[+] Get EOF\"" + "\n"
        self.exploit += self.tab*3 + "break" + "\n"
        self.exploit += self.tab*1 + "except Exception as e:" + "\n"
        self.exploit += self.tab*3 + "print str(e)" + "\n"
        self.exploit += self.tab*3 + "r.close()" + "\n"
        self.exploit += self.tab*3 + "break"
        print self.exploit
